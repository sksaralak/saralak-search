...
export const proofItems = [
  {
    title: 'การเติบโตของ Organic Traffic',
    caption:
      'ตัวอย่างการเติบโตของคลิกและ Impression หลังปรับปรุงโครงสร้างหน้า Product Listing และ SEO On-page โดยเบลอข้อมูลลูกค้าที่อ่อนไหวแล้ว',
    metric: 'Organic Traffic Growth',
    image: '/proof/gsc-product-listing-growth.png',
  },
  {
    title: 'ตัวอย่างอันดับคีย์เวิร์ดบน Google',
    caption:
      'ตัวอย่างคีย์เวิร์ดที่สามารถแข่งขันบนหน้าแรกของ Google ได้ดีขึ้น หลังการปรับโครงสร้างเนื้อหาและ On-page SEO',
    metric: 'Keyword Ranking Improvement',
    image: '/proof/ranking-bangsaen-serp.png',
  },
  {
    title: 'การมองเห็นบน Google AI Overview',
    caption:
      'ตัวอย่างการปรากฏใน AI Overview ซึ่งเป็นรูปแบบการค้นหาใหม่ที่ธุรกิจควรเริ่มเตรียมความพร้อม',
    metric: 'AI Search Visibility',
    image: '/proof/google-ai-overview-visibility.png',
  },
  {
    title: 'การปรากฏในคำแนะนำของ ChatGPT',
    caption:
      'ตัวอย่างการที่สินค้าและแบรนด์ถูกแนะนำใน ChatGPT จากการวาง Content, Entity และ Search Visibility ให้ชัดเจนขึ้น',
    metric: 'ChatGPT Recommendation Visibility',
